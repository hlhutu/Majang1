 ...
 */
function tileToNumber(tile: MahjongData): number {
    switch (tile.color) {
...
export class YakuCalculator {
    ...
    private static checkTanyao(allTiles: MahjongData[]): YakuResult | null {
    ...
    private static checkYakuhai(allTiles: MahjongData[], prevalentWind: number, seatWind: number): YakuResult[] {
    ...
    private static checkPinfu(decomposition: HandDecomposition, winningTile: MahjongData, prevalentWind: number, seatWind: number): YakuResult | null {
